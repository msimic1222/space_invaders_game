...
const START_SPEED = 0.8;     // slower starting speed
const SPEED_INCREASE = 0.04; // very small increase per alien
const MAX_SPEED = 2.2;       // cap so it never gets crazy

const bulletSpeed = 5;       // slightly slower bullets
